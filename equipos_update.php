<?php
    ...
    $query = extraerEquipo(base64_decode($_GET['id']));
...
<div class="panel panel-default" style="margin-top: 10 px">
    ...
    <div class="panel-body">
        <form action="php/registros/tipos_equipo.php?accion=UDT" method="POST">
            <div class="row">
                <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-offset-2 col-xs-12 col-xs-offset-0">
                    <div class="form-group">
                        ...
                        <input class="form-control" readonly type="text" name="codigo" id="codigo" value="<?php echo $row['codtipo_equipo'] ?>" require>
                    </div>
                </div>    
